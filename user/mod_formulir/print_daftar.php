...
<html>
    ...
    <body>
        ...
        <hr>
		<b><center>Formulir Pendaftaran Peserta Didik Baru Tahun 2024</center></b>
		<br>
			...
			<tr>
				<td width="5%"></td>
				<td width="35%" align="">Nomor Pendaftaran</td>
				<td width="5%" align="center">:</td>
				<td width="60%" align="left">
				    <?= $siswa['no_daftar'] ?> (Diisi Panitia)
				</td>
