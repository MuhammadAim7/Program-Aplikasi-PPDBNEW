        ...
        <div class="card author-box card-primary">
            ...
            <div class="card-body">
			 ...
			 <div class="alert alert-success alert-dismissable">
				...
				Terimakasih !!!<br />
				Data Anda Telah Berhasil <button class="badge badge-danger"> Dikonfirmasi Pada Tanggal  <?= $siswa['tgl_konfirmasi'] ?></button><br /><br />
				<h5>Silahkan Download Formulir daftar ulang di bawah ini, dan melakukan daftar ulang ke sekertariat PPDB</h5>
			</div>
			<div class="card-body">
		<div class="row">
		<div class="col-lg-4">
	...
	<div class="popup-container bg-green">
		...
		<form action="" method="post" class="popup-form">
			 ...
			 <div class="alert alert-success alert-dismissable">
				<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
				Terimakasih !!!<br />
				Data Anda Telah Berhasil <button class="badge badge-primary"> Dikonfirmasi Pada Tanggal  <?= $siswa['tgl_konfirmasi'] ?></button>
			</div>
