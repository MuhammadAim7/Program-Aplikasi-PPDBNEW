  ...
  <head>
    ...
    <div id="app">
      ...
      <div class="main-wrapper main-wrapper-1">
        <div class="navbar-bg" style="background-color: #007bff;"></div>
...
crossorigin="anonymous"></script>
     ...
     <link rel="stylesheet" href="../assets/css/user.css">                                      
          ...
          <aside id="sidebar-wrapper" >
			...
			<div class="menu-header" >
				<ul>
					...
					<li>
						<a style="color:#fff" class="btn-logout" href="?pg=setting">
							<span class="fas fa-user-cog "></span><br>Setting
						</a>
					</li>
					<li>
						<a style="color:#fff" href="logout.php" class="btn-logout"> <span class="fas fa-sign-out-alt  "></span><br>Keluar</a>
					</li>
				</ul>
			</div>
        ...
        <footer class="main-footer">
          ...
          Zulaikah Setia Dewi - <b>STMIK AKI PATI</b>
