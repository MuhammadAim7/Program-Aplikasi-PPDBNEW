...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
			<p>
				Jika Tulisan Terdapat <b>Lihat Disini</b> Siswa Sudah Mengupload Berkas </p>
                <div class="table-responsive">
                    <table style="font-size: 12px " class="table table-bordered  table-striped table-sm" id="table-1">
