    ...
    <div class="tab-content" id="myTabContent5">
        ...
        <form id="form-setting1">
            <div class="card" id="settings-card">
                     ...
                     <div class="form-group row align-items-center">
                        <label for="site-title" class="form-control-label col-sm-3 text-md-right"><b>NSM:</b></label>
                        <div class="col-sm-6 col-md-9">
                            <?= $setting['nsm'] ?>
                        </div>
                    </div>
                    <div class="form-group row align-items-center">
                        <label for="site-title" class="form-control-label col-sm-3 text-md-right"><b>NPSN:</b></label>
                        <div class="col-sm-6 col-md-9">
                            <?= $setting['npsn'] ?>
                        </div>
                    </div>
                    <div class="form-group row align-items-center">
                        <label for="site-title" class="form-control-label col-sm-3 text-md-right"><b>Nama Sekolah:</b></label>
                        <div class="col-sm-6 col-md-9">
                    ...
                    <div class="form-group row align-items-center">
                        <label for="site-description" class="form-control-label col-sm-3 text-md-right"><b>Status Sekolah:</b></label>
                        <div class="col-sm-6 col-md-9">
      ...
      <div class="tab-pane fade" id="profile5" role="tabpanel" aria-labelledby="profile-tab5">
        <form id="form-setting2">
            <div class="card" id="settings-card">
                     ...
                     <div class="form-group row align-items-center">
                        <label for="site-title" class="form-control-label col-sm-3 text-md-right"><b>Alamat Lengkap:</b></label>
                        <div class="col-sm-6 col-md-9">
                            <?= $setting['alamat'] ?>
                        </div>
                    </div>
                    <div class="form-group row align-items-center">
                        <label for="site-title" class="form-control-label col-sm-3 text-md-right"><b>Provinsi:</b></label>
                        <div class="col-sm-6 col-md-9">
                            <?= $setting['provinsi'] ?>
                        </div>
                    </div>
                    <div class="form-group row align-items-center">
                        <label for="site-title" class="form-control-label col-sm-3 text-md-right"><b>Kabupaten:</b></label>
                        <div class="col-sm-6 col-md-9">
                            <?= $setting['kab'] ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group row align-items-center">
                        <label for="site-description" class="form-control-label col-sm-3 text-md-right"><b>Kecamatan:</b></label>
                        <div class="col-sm-6 col-md-9">
      ...
      <div class="tab-pane fade" id="contact5" role="tabpanel" aria-labelledby="contact-tab5">
            ...
            <div class="card" id="settings-card">
                     ...
                     <div class="form-group row align-items-center">
                        <label for="site-title" class="form-control-label col-sm-3 text-md-right"><b>No Telpon:</b></label>
                        <div class="col-sm-6 col-md-9">
                            <?= $setting['no_telp'] ?>
                        </div>
                    </div>
                    <div class="form-group row align-items-center">
                        <label for="site-title" class="form-control-label col-sm-3 text-md-right"><b>Email:</b></label>
                        <div class="col-sm-6 col-md-9">
                            <?= $setting['email'] ?>
                        </div>
                    </div>
      ...
      <div class="tab-pane fade" id="kepala5" role="tabpanel" aria-labelledby="kepala-tab5">
            ...
            <div class="card" id="settings-card">
                     ...
                     <div class="form-group row align-items-center">
                        <label for="site-title" class="form-control-label col-sm-3 text-md-right"><b>Kepala Sekolah:</b></label>
                        <div class="col-sm-6 col-md-9">
                            <?= $setting['kepala'] ?>
                        </div>
                    </div>
                    <div class="form-group row align-items-center">
                        <label for="site-title" class="form-control-label col-sm-3 text-md-right"><b>NIP:</b></label>
                        <div class="col-sm-6 col-md-9">
                            <?= $setting['nip'] ?>
                        </div>
                    </div>
...
<div class="box box-solid">
	...
	<div class="box-body">
		...
		<ul class="list-group">
			...
			<li class="list-group-item"><img src="../dist/img/support.png" width="45" alt="">
							<a href="https://api.whatsapp.com/send?phone=+62<?= $setting['nolivechat'] ?>&text=<?= $setting['livechat'] ?>" target="_blank" class="btn btn-success">
